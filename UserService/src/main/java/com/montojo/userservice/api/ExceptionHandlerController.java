...
public class ExceptionHandlerController {
    ...
    public Map<String, String> handleNotFoundException(EntityNotFoundException ex) {
        ...
        String message = "User with " + ex.getMessage().substring(ex.getMessage().indexOf("id")) + " not found.";
        log.info(message);
        Map<String, String> errors = new HashMap<>();
    ...
    public Map<String, String> handleEmptyResultDataException(EmptyResultDataAccessException ex) {
        ...
        String message = "User with " + ex.getMessage().substring(ex.getMessage().indexOf("id"), ex.getMessage().indexOf("exists"))+ "not found.";
        log.info(message);
        Map<String, String> errors = new HashMap<>();
        errors.put("Message", message);
        return errors;
